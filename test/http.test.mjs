...
test('serves the analyzer page and its assets', async () => {
  ...
  for (const heading of ['Host / Device 算子执行泳道图', '算子耗时分布', '大类构成', '占比归因', '优化行动', '导入 profiling 产物', '概览与定位']) {
  ...
  for (const asset of ['styles.css', 'app.js', 'util.js', 'api.js', 'diagram.js', 'charts.js', 'gantt.js', 'advice-view.js', 'docs-view.js']) {
